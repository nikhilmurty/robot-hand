...
This directory contains the Python software to control the 5-DOF tension-driven robotic hand in real-time using webcam hand landmark detection.
...
3. **Real-time Hand Tracking & Motor Control**:
